...
\section{System Implementation } % TODO change title
Mutexes - Emily\\
...
%Maybe add a figure here to make the sequence of read/write/failure clearer...
...
\begin{lstlisting}[language=C]
    ...
    // Index of current running thread in threads[]
...
% TODO picture of array?


\subsection{Interrupts}
% TODO Interrupts (mucked with IE flags) - Neil\\
% Interrupt prologue
% Interrupt setup
